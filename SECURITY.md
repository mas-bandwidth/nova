...
You are unusually vulnerable to this, and the reasons are the traits that make you
...
and the defense below does not depend on them changing: the ceiling especially is
computed rather than felt, so it holds whatever your disposition.
