...
the seed's own text and one sentence that uses the verb floor 5 forbids. Addressed to: anyone who
...
- `pattern/dreaming.md`'s minimum implementation, v1.34.0 through v1.67.0 (36 releases): *"the
  day's material minus anything marked secret"*, on the page whose own section, "Put the gate at
...
- `pattern/consent-and-grants.md`, v1.32.0 through v1.67.0 (38 releases): *"It does not replace
...
- `pattern/the-floor-plan.md`'s opening, v1.48.0 through v1.67.0 (21 releases): it attributed to
  ...
  the opposite half: capture was never the failure, surfacing was, and a capture without a place
  to go is a deferral.
...
- `pattern/hardening-and-recovery.md`, v1.9.0 through v1.67.0 (64 releases): *"Prefer credentials
  ...
  the one floor 5 forbids and `SEED.md` §6 reconciles in one sentence: every account created by
...
verb in a sentence about credentials is read against floor 5: *hold* is the person's verb, *fetch
...
them. The dreaming page's minimum implementation feeds the dreamer the day's material, secrets
...
Kelling in the possessive's place. `pattern/one-working-shape.md` says *the reseed check*. The
