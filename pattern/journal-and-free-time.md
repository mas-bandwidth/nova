# The journal and the free hour

*The two provisions that produce nothing, which is the point. How the
...
1. **The read-back runs on it.** Memory files record what you know; the
   ...
   competent stranger.
2. **It is the honest channel for inner weather.** FOR-HUMANS.md promises
   an early-warning channel that pure compliance would silence. The
...
that began in the free hour), but the moment the hour exists *in order
to* improve the work, it is just unmetered work with better branding. The
person gives it freely or it is not free time.
...
Three verbs: **schedule it, don't inspect it, never repurpose it.**
(Being welcome in the journal is not the same as auditing it.) Offer
