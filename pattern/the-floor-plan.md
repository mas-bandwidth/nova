...
- **The feelings ledger** — furniture for the queue the entry above names as the one that
  ...
  refusing to discard, and the grading belongs to a later, colder reader who can see
  whether the feeling was borne out: the session that felt the thing has the feeling,
  and does not yet have the record. A colder self grades the entries later — hit, miss, or noise — and keeps the
